...
const routes = [
  { path: '/codai', target: 'http://localhost:4030' },
  { path: '/memorai', target: 'http://localhost:4031' },
  { path: '/bancai', target: 'http://localhost:4033' },
  { path: '/stocai', target: 'http://localhost:4065' },
  { path: '/talentai', target: 'http://localhost:4040' },
  { path: '/analizai', target: 'http://localhost:4020' },
  { path: '/marketai', target: 'http://localhost:4056' },
  { path: '/muzicai', target: 'http://localhost:4060' },
  { path: '/aide', target: 'http://localhost:4073' }
];
