...
import { AdminIntegrationManager } from '@/lib/integrations/admin';

describe('admin Integration Tests', () => {
  let integrationManager: AdminIntegrationManager;

  beforeEach(() => {
    integrationManager = new AdminIntegrationManager();
  });
