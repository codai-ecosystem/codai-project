        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                ...
                <section className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
                    <article className="backdrop-blur-sm bg-white/10 dark:bg-gray-800/20 rounded-2xl border border-white/20 dark:border-gray-700/20 p-4 sm:p-6 shadow-lg hover:shadow-xl transition-all duration-200">
                        <header className="mb-4 sm:mb-6">
                            <h3 className="text-gray-300 flex items-center gap-2 text-lg font-semibold">
                                <Monitor className="h-4 sm:h-5 w-4 sm:w-5 text-blue-400" />
                                System Resources
                            </h3>
                    ...
                    <article className="backdrop-blur-sm bg-white/10 dark:bg-gray-800/20 rounded-2xl border border-white/20 dark:border-gray-700/20 p-4 sm:p-6 shadow-lg hover:shadow-xl transition-all duration-200">
                        <header className="mb-4 sm:mb-6">
                            <h3 className="text-gray-300 flex items-center gap-2 text-lg font-semibold">
                                <Activity className="h-4 sm:h-5 w-4 sm:w-5 text-green-400" />
                                Recent Activities
                            </h3>
                            <p className="text-gray-400 text-xs sm:text-sm mt-1">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center gap-3">
                                <AlertTriangle className="h-3 sm:h-4 w-3 sm:w-4 text-yellow-400 flex-shrink-0" />
                                <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-3">
                                <Users className="h-3 sm:h-4 w-3 sm:w-4 text-blue-400 flex-shrink-0" />
                                <div className="flex-1 min-w-0">
                ...
                <section className="backdrop-blur-sm bg-white/10 dark:bg-gray-800/20 rounded-2xl border border-white/20 dark:border-gray-700/20 p-4 sm:p-6 shadow-lg hover:shadow-xl transition-all duration-200">
                    <header className="mb-4 sm:mb-6">
                        <h3 className="text-gray-300 flex items-center gap-2 text-lg font-semibold">
                            <Settings className="h-4 sm:h-5 w-4 sm:w-5 text-purple-400" />
                            Quick Actions
                        </h3>
                        <p className="text-gray-400 text-xs sm:text-sm mt-1">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4">
                        <button className="h-16 sm:h-20 flex flex-col items-center justify-center gap-1 sm:gap-2 backdrop-blur-md bg-white/5 dark:bg-gray-800/10 border border-white/10 dark:border-gray-700/20 hover:bg-white/10 hover:border-blue-500/30 rounded-xl transition-all duration-200">
                            <Users className="h-4 sm:h-5 w-4 sm:w-5 text-blue-400" />
                            <span className="text-xs text-gray-300">User Management</span>
                        </button>

                        <button className="h-16 sm:h-20 flex flex-col items-center justify-center gap-1 sm:gap-2 backdrop-blur-md bg-white/5 dark:bg-gray-800/10 border border-white/10 dark:border-gray-700/20 hover:bg-white/10 hover:border-green-500/30 rounded-xl transition-all duration-200">
                            <Database className="h-4 sm:h-5 w-4 sm:w-5 text-green-400" />
                            <span className="text-xs text-gray-300">Database Admin</span>
                        </button>

                        <button className="h-16 sm:h-20 flex flex-col items-center justify-center gap-1 sm:gap-2 backdrop-blur-md bg-white/5 dark:bg-gray-800/10 border border-white/10 dark:border-gray-700/20 hover:bg-white/10 hover:border-purple-500/30 rounded-xl transition-all duration-200">
                            <Shield className="h-4 sm:h-5 w-4 sm:w-5 text-purple-400" />
                            <span className="text-xs text-gray-300">Security Settings</span>
                        </button>

                        <button className="h-16 sm:h-20 flex flex-col items-center justify-center gap-1 sm:gap-2 backdrop-blur-md bg-white/5 dark:bg-gray-800/10 border border-white/10 dark:border-gray-700/20 hover:bg-white/10 hover:border-cyan-500/30 rounded-xl transition-all duration-200">
                            <BarChart3 className="h-4 sm:h-5 w-4 sm:w-5 text-cyan-400" />
                            <span className="text-xs text-gray-300">Analytics</span>
                        </button>

                        <button className="h-16 sm:h-20 flex flex-col items-center justify-center gap-1 sm:gap-2 backdrop-blur-md bg-white/5 dark:bg-gray-800/10 border border-white/10 dark:border-gray-700/20 hover:bg-white/10 hover:border-yellow-500/30 rounded-xl transition-all duration-200">
                            <HardDrive className="h-4 sm:h-5 w-4 sm:w-5 text-yellow-400" />
                            <span className="text-xs text-gray-300">System Backup</span>
                        </button>

                        <button className="h-16 sm:h-20 flex flex-col items-center justify-center gap-1 sm:gap-2 backdrop-blur-md bg-white/5 dark:bg-gray-800/10 border border-white/10 dark:border-gray-700/20 hover:bg-white/10 hover:border-red-500/30 rounded-xl transition-all duration-200">
                            <Settings className="h-4 sm:h-5 w-4 sm:w-5 text-red-400" />
