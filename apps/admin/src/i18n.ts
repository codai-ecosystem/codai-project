 ...
 * @description React-i18next configuration for admin
 */
...
i18n.on('languageChanged', (lng) => {
  ...
  if (locale) {
    ...
    localStorage.setItem('admin_locale', lng);
    document.cookie = `admin_locale=${lng}; path=/; max-age=31536000`;
