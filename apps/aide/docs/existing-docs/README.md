...
### `/existing-docs/`
Legacy documentation from the original structure (see individual README files):
- Architecture guides
- Development setup
- API documentation
...
- [Quick Start Guide](./deployment/) - Fast deployment guide
...
- [Node.js Requirements](./compatibility/) - Environment requirements
...
4. [GitHub Issues](https://github.com/aide-dev/aide/issues) for bug reports
