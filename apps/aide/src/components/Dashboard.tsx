  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold">AIDE Dashboard</h1>
          <p className="text-muted-foreground">
            Welcome back, {session?.user?.name || 'User'}! Here's your AIDE overview.
          </p>
        </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            {Object.entries(AIDEFeatures).map(([category, items]) => (
