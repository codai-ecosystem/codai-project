...
describe('AIDE Service - E2E Tests', () => {
  let browser: Browser;
  let page: Page;
  ...
  describe('Application Loading', () => {
    it('should load the main page successfully', async () => {
      ...
      await expect(page).toHaveURL(/${serviceName}/i);
  ...
  describe('Core Functionality', () => {
    ...
    it('should handle data persistence', async () => {
      ...
      await page.reload();
      await expect(page.locator('[data-testid="data-list"]')).toContain(
        'Test Data'
      );
    });
    ...
    it('should handle real-time updates', async () => {
      ...
      await expect(page2.locator('[data-testid="updates-list"]')).toContain(
        'Real-time test'
      );
