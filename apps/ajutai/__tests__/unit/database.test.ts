...
import { AjutaiRepository } from '../src/repositories/AjutaiRepository';

describe('AjutaiRepository Database Tests', () => {
  let prisma: PrismaClient;
  let repository: AjutaiRepository;
  ...
  beforeAll(async () => {
    ...
    repository = new AjutaiRepository(prisma);
