  ...
  const [featureCards] = useState<FeatureCard[]>([
    {
      ...
      description: 'Advanced ai chat support capabilities with AI optimization',
      icon: 'MessageCircle',
      status: 'active'
    },
    {
      ...
      description: 'Advanced ticket management capabilities with AI optimization',
      icon: 'Headphones',
      status: 'active'
    },
    {
      ...
      description: 'Advanced knowledge base capabilities with AI optimization',
      icon: 'Book',
      status: 'active'
    },
    {
        ...
        <AnimatePresence mode="wait">
          {activeTab === 'overview' && (
            ...
            >
              ...
              >
                <h2 className="text-2xl font-bold text-green-400 mb-4">Intelligent customer support and assistance platform powered by AI</h2>
                ...
                {featureCards.map((feature, index) => (
                  ...
                  >
                    ...
                    <div className="flex justify-end">
                      <button className="bg-gradient-to-r from-green-500 to-purple-500 text-white px-4 py-2 rounded-xl hover:from-green-600 hover:to-purple-600 transition-all font-medium text-sm flex items-center gap-2">
                        Learn More
          ...
          {(activeTab === 'analytics' || activeTab === 'settings') && (
            ...
            >
              ...
              <button className="bg-gradient-to-r from-green-500 to-purple-500 text-white px-6 py-3 rounded-xl hover:from-green-600 hover:to-purple-600 transition-all font-medium">
                Coming Soon
              </button>
            </motion.div>
          )}
