/**
 * Vitest Configuration for ajutai
...
import { baseVitestConfig } from '../../packages/testing-utils/dist/configs/vitest.base.config'
...
export default defineConfig({
    ...
    test: {
        ...
        // Remove workspace configuration from base
        workspace: undefined,
