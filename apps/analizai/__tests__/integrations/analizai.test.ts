...
import { AnalizaiIntegrationManager } from '@/lib/integrations/analizai';

describe('analizai Integration Tests', () => {
  let integrationManager: AnalizaiIntegrationManager;

  beforeEach(() => {
    integrationManager = new AnalizaiIntegrationManager();
  });
