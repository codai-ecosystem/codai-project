...
import { BancaiRepository } from '../src/repositories/BancaiRepository';

describe('BancaiRepository Database Tests', () => {
  let prisma: PrismaClient;
  let repository: BancaiRepository;
  ...
  beforeAll(async () => {
    ...
    repository = new BancaiRepository(prisma);
