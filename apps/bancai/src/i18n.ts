 ...
 * @description React-i18next configuration for bancai
 */
...
i18n
  ...
  .init({
    ...
    detection: {
      ...
      lookupCookie: 'bancai_locale',
      lookupLocalStorage: 'bancai_locale',
...
i18n.on('languageChanged', (lng) => {
  ...
  if (locale) {
    ...
    localStorage.setItem('bancai_locale', lng);
    document.cookie = `bancai_locale=${lng}; path=/; max-age=31536000`;
