 ...
 * @description React-i18next configuration for codai
 */
...
i18n
  ...
  .init({
    ...
    detection: {
      ...
      lookupCookie: 'codai_locale',
      lookupLocalStorage: 'codai_locale',
...
i18n.on('languageChanged', (lng) => {
  ...
  if (locale) {
    ...
    localStorage.setItem('codai_locale', lng);
    document.cookie = `codai_locale=${lng}; path=/; max-age=31536000`;
