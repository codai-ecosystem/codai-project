...
export const CardSkeleton: React.FC<{
    ...
    rows = 3
        ...
        return (
            <div className={`animate-pulse rounded-xl border ${theme === 'dark'
                    ? 'bg-gray-800 border-gray-700'
                    : 'bg-gray-100 border-gray-200'
                } p-6 ${className}`}>
                {/* Header skeleton */}
                <div className="flex items-center space-x-4 mb-4">
                    <div className={`h-12 w-12 rounded-lg ${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-300'
                        }`} />
                    <div className="space-y-2">
                        <div className={`h-4 w-32 rounded ${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-300'
                            }`} />
                        <div className={`h-3 w-24 rounded ${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-300'
                            }`} />
                    </div>
                </div>
                ...
                <div className="space-y-3">
                    {Array.from({ length: rows }).map((_, i) => (
                        <div
                            key={i}
                            className={`h-4 rounded ${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-300'
                                }`}
                ...
                <div className="flex justify-between items-center mt-6">
                    <div className={`h-6 w-20 rounded-full ${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-300'
                        }`} />
                    <div className={`h-8 w-24 rounded-lg ${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-300'
                        }`} />
                </div>
            </div>
        );
...
export const ShimmerLoader: React.FC<{
    ...
    className = ''
        ...
        return (
            <div
                className={`relative overflow-hidden rounded ${theme === 'dark' ? 'bg-gray-800' : 'bg-gray-200'
                    } ${className}`}
                style={{ width, height }}
            >
                <motion.div
    ...
    onStateChange
        ...
        const getIcon = () => {
            switch (state) {
                ...
                default:
                    return (
                        <div className={`w-full h-full rounded-full ${theme === 'dark' ? 'bg-gray-600' : 'bg-gray-300'
                            }`} />
                    );
            }
        };
