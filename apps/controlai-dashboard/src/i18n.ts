 ...
 * @description React-i18next configuration for controlai-dashboard
 */
...
i18n
  ...
  .init({
    ...
    detection: {
      ...
      lookupCookie: 'controlai-dashboard_locale',
      lookupLocalStorage: 'controlai-dashboard_locale',
...
i18n.on('languageChanged', (lng) => {
  ...
  if (locale) {
    ...
    localStorage.setItem('controlai-dashboard_locale', lng);
    document.cookie = `controlai-dashboard_locale=${lng}; path=/; max-age=31536000`;
