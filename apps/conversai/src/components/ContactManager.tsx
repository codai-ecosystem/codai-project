                    ...
                    <div className="w-64 border-r border-gray-200 p-4 bg-gray-50">
                        ...
                        <div className="space-y-2">
                            <button
                                ...
                                className={`w-full text-left px-3 py-2 rounded-lg transition-colors ${selectedTag === null ? 'bg-blue-100 text-blue-700' : 'hover:bg-gray-100'
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`w-full text-left px-3 py-2 rounded-lg transition-colors ${selectedTag === 'starred' ? 'bg-blue-100 text-blue-700' : 'hover:bg-gray-100'
                                    }`}
                            >
                            ...
                            <div className="space-y-1">
                                {allTags.map(tag => (
                                    <button
                                        ...
                                        className={`w-full text-left px-3 py-2 rounded-lg transition-colors text-sm ${selectedTag === tag ? 'bg-blue-100 text-blue-700' : 'hover:bg-gray-100'
                                            }`}
                                    >
