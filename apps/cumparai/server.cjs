...
const server = http.createServer((req, res) => {
  ...
  if (pathname === '/health') {
    ...
    res.end(JSON.stringify({ 
      ...
      description: 'AI Shopping Platform - E-commerce intelligence and product comparison',
  ...
  if (pathname === '/api/info') {
    ...
    res.end(JSON.stringify({
      ...
      description: 'AI Shopping Platform - E-commerce intelligence and product comparison',
      port: PORT,
      features: ["Product Comparison","Price Intelligence","Shopping AI","Market Analysis"],
      status: 'operational',
      uptime: process.uptime()
    }));
    return;
      ...
      <body>
        <div class="container">
          <div class="header">
            ...
            <p>AI Shopping Platform - E-commerce intelligence and product comparison</p>
            <div>
              <span class="badge">App Category</span>
              <span class="badge">Port: 3008</span>
