    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-violet-900 to-slate-900 text-white">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            >
              Legal technology platform with document analysis, case management, and compliance automation.
            </motion.p>
      ...
      <section id="features" className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Experience the future of Legal with our comprehensive platform
          </p>
        </motion.div>
          ...
          {[
            {
              ...
              description: 'AI-powered legal document review and analysis with clause detection'
            },
            {
              icon: <Users className="w-8 h-8" />,
              title: 'Case Management',
              description: 'Comprehensive case tracking and legal workflow automation'
            },
            {
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Join thousands of users who are already using CURTAI to achieve better results faster.
          </p>
          <button
            onClick={handleGetStarted}
      ...
      <footer className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-800">
        <div className="text-center text-gray-400">
          <p>&copy; 2025 CURTAI. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
