...
- Name: DEXAI Admin Dashboard >> should display admin dashboard interface
- Location: E:\GitHub\dexai\apps\web\e2e-tests\admin-dashboard.spec.ts:9:7
...
Locator: locator('h1')
Expected string: "DEXAI Admin Dashboard"
Received string: "Sign In"
Call log:
  - expect.toContainText with timeout 5000ms
  - waiting for locator('h1')
    9 × locator resolved to <h1 class="text-2xl font-bold text-gray-900">Sign In</h1>
      - unexpected value "Sign In"

    at E:\GitHub\dexai\apps\web\e2e-tests\admin-dashboard.spec.ts:13:38
```
