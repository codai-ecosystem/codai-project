...
- Name: DEXAI Admin Dashboard >> should navigate to database tab
- Location: E:\GitHub\dexai\apps\web\e2e-tests\admin-dashboard.spec.ts:41:7
...
Locator: locator('button').filter({ hasText: 'Database' })
Expected: visible
...
Call log:
  ...
  - waiting for locator('button').filter({ hasText: 'Database' })
    ...
    at E:\GitHub\dexai\apps\web\e2e-tests\admin-dashboard.spec.ts:46:31
```
