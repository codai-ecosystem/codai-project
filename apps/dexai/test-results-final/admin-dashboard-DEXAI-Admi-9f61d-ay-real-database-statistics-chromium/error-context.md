...
- Name: DEXAI Admin Dashboard >> should display real database statistics
- Location: E:\GitHub\dexai\apps\web\e2e-tests\admin-dashboard.spec.ts:23:7
...
Locator: locator('text=Total Words')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('text=Total Words')

    at E:\GitHub\dexai\apps\web\e2e-tests\admin-dashboard.spec.ts:27:52
```
