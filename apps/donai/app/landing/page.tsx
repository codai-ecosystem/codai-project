    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-green-900 to-slate-900 text-white">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            >
              AI-powered donation and fundraising platform with impact tracking and donor management.
            </motion.p>
      ...
      <section id="features" className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Experience the future of Non-profit with our comprehensive platform
          </p>
        </motion.div>
          ...
          {[
            {
              ...
              description: 'Comprehensive donation impact measurement and transparency reporting'
            },
            {
              icon: <Users className="w-8 h-8" />,
              title: 'Donor Management',
              description: 'Advanced donor relationship management with personalized engagement'
            },
            {
              icon: <Zap className="w-8 h-8" />,
              title: 'Campaign Optimization',
              description: 'AI-driven fundraising campaign optimization and audience targeting'
            }
          ].map((feature, index) => (
            <motion.div
              key={index}
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          <h2 className="text-4xl font-bold text-white mb-6">
            Ready to Transform Your Non-profit Workflow?
          </h2>
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Join thousands of users who are already using DONAI to achieve better results faster.
          </p>
          <button
            onClick={handleGetStarted}
      ...
      <footer className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-800">
        <div className="text-center text-gray-400">
          <p>&copy; 2025 DONAI. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
