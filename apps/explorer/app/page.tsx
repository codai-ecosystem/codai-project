  ...
  const [featureCards] = useState<FeatureCard[]>([
    {
      ...
      description: 'Advanced data discovery capabilities with AI optimization',
      icon: 'Search',
      status: 'active'
    },
    {
      ...
      description: 'Advanced exploration tools capabilities with AI optimization',
      icon: 'Database',
      status: 'active'
    },
    {
        ...
        <AnimatePresence mode="wait">
          {activeTab === 'overview' && (
            ...
            >
              ...
              >
                <h2 className="text-2xl font-bold text-orange-400 mb-4">Advanced data exploration and discovery platform with AI-powered insights</h2>
                ...
                {featureCards.map((feature, index) => (
                  ...
                  >
                    ...
                    <div className="flex justify-end">
                      <button className="bg-gradient-to-r from-orange-500 to-purple-500 text-white px-4 py-2 rounded-xl hover:from-orange-600 hover:to-purple-600 transition-all font-medium text-sm flex items-center gap-2">
                        Learn More
