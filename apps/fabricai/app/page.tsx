  ...
  const [featureCards] = useState<FeatureCard[]>([
    {
      ...
      description: 'Advanced model training capabilities with AI optimization',
      icon: 'Brain',
      status: 'active'
    },
    {
      ...
      description: 'Advanced code generation capabilities with AI optimization',
      icon: 'Code',
      status: 'active'
    },
    {
      id: '3',
      title: 'Templates',
      description: 'Advanced templates capabilities with AI optimization',
      icon: 'Cpu',
      status: 'active'
    },
    {
        ...
        <AnimatePresence mode="wait">
          {activeTab === 'overview' && (
            ...
            >
              ...
              >
                <h2 className="text-2xl font-bold text-purple-400 mb-4">Advanced AI development platform for building and deploying AI models</h2>
