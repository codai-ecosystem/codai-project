      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            >
              Central integration platform connecting multiple services and managing data flow.
            </motion.p>
      ...
      <section id="features" className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Experience the future of Integration with our comprehensive platform
          </p>
        </motion.div>
          ...
          {[
            {
              ...
              description: 'Seamless connection between multiple services and external APIs'
            },
            {
              icon: <Users className="w-8 h-8" />,
              title: 'Data Orchestration',
              description: 'Intelligent data flow management and transformation pipelines'
            },
            {
              icon: <Zap className="w-8 h-8" />,
              title: 'Workflow Automation',
              description: 'Advanced workflow automation with conditional logic and triggers'
            }
          ].map((feature, index) => (
            <motion.div
              key={index}
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Join thousands of users who are already using HUB to achieve better results faster.
          </p>
          <button
            onClick={handleGetStarted}
