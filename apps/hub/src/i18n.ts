 ...
 * @description React-i18next configuration for hub
 */
...
i18n
  ...
  .init({
    ...
    detection: {
      ...
      lookupCookie: 'hub_locale',
      lookupLocalStorage: 'hub_locale',
...
i18n.on('languageChanged', (lng) => {
  ...
  if (locale) {
    ...
    localStorage.setItem('hub_locale', lng);
    document.cookie = `hub_locale=${lng}; path=/; max-age=31536000`;
