...
import { IdRepository } from '../src/repositories/IdRepository';

describe('IdRepository Database Tests', () => {
  let prisma: PrismaClient;
  let repository: IdRepository;
  ...
  beforeAll(async () => {
    ...
    repository = new IdRepository(prisma);
