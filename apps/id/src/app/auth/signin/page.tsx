    ...
    <div className="min-h-screen bg-gradient-to-br from-white to-gray-100 flex items-center justify-center px-4">
      <div className="max-w-md w-full space-y-8">
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium py-2 px-4 rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-codai-500 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-6" data-testid="signin-form">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-codai-600 hover:bg-codai-700 text-white font-medium py-2 px-4 rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-codai-500 disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        <div className="text-center">
          <p className="text-xs text-gray-500">
            OAuth Integration • Development Mode
          </p>
        </div>
      </div>
    </div>
