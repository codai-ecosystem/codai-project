 ...
 * @description React-i18next configuration for id
 */
...
i18n
  ...
  .init({
    ...
    detection: {
      ...
      lookupCookie: 'id_locale',
      lookupLocalStorage: 'id_locale',
...
i18n.on('languageChanged', (lng) => {
  ...
  if (locale) {
    ...
    localStorage.setItem('id_locale', lng);
    document.cookie = `id_locale=${lng}; path=/; max-age=31536000`;
