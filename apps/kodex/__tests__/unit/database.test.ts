...
import { KodexRepository } from '../src/repositories/KodexRepository';

describe('KodexRepository Database Tests', () => {
  let prisma: PrismaClient;
  let repository: KodexRepository;
  ...
  beforeAll(async () => {
    ...
    repository = new KodexRepository(prisma);
