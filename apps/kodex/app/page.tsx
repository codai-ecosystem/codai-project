  ...
  const [featureCards] = useState<FeatureCard[]>([
    {
      ...
      description: 'Advanced code repository capabilities with AI optimization',
      icon: 'GitBranch',
      status: 'active'
    },
    {
    ...
    },
    {
      id: '3',
      title: 'AI Analysis',
      description: 'Advanced ai analysis capabilities with AI optimization',
      icon: 'Brain',
      status: 'active'
    },
    {
          ...
          <div className="flex items-center justify-between">
            ...
            >
              <div className="w-14 h-14 bg-gradient-to-r from-gray-500 to-purple-500 rounded-2xl flex items-center justify-center">
                {renderIcon('GitBranch', 'w-8 h-8 text-white')}
              </div>
              <div>
        ...
        <AnimatePresence mode="wait">
          {activeTab === 'overview' && (
            ...
            >
              ...
              >
                <h2 className="text-2xl font-bold text-gray-400 mb-4">Advanced code repository and collaboration platform with AI-powered features</h2>
