...
import { LegalizaiRepository } from '../src/repositories/LegalizaiRepository';

describe('LegalizaiRepository Database Tests', () => {
  let prisma: PrismaClient;
  let repository: LegalizaiRepository;
  ...
  beforeAll(async () => {
    ...
    repository = new LegalizaiRepository(prisma);
