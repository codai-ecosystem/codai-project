  ...
  const [featureCards] = useState<FeatureCard[]>([
    {
      id: '1',
      title: 'Log Analysis',
      description: 'Advanced log analysis capabilities with AI optimization',
      icon: 'FileText',
      status: 'active'
    },
    {
    ...
    },
    {
      ...
      description: 'Advanced real-time monitoring capabilities with AI optimization',
      icon: 'AlertTriangle',
      status: 'active'
    },
    {
      ...
      description: 'Advanced anomaly detection capabilities with AI optimization',
      icon: 'Activity',
      status: 'active'
    }
  ])
          ...
          <div className="flex items-center justify-between">
            ...
            >
              <div className="w-14 h-14 bg-gradient-to-r from-blue-500 to-purple-500 rounded-2xl flex items-center justify-center">
                {renderIcon('FileText', 'w-8 h-8 text-white')}
              </div>
              <div>
        ...
        <AnimatePresence mode="wait">
          {activeTab === 'overview' && (
            ...
            >
              ...
              >
                <h2 className="text-2xl font-bold text-blue-400 mb-4">Intelligent log management and analysis with AI-driven insights</h2>
