...
import { MarketaiRepository } from '../src/repositories/MarketaiRepository';

describe('MarketaiService', () => {
  let service: MarketaiService;
  let mockRepository: jest.Mocked<MarketaiRepository>;
  ...
  beforeEach(() => {
    ...
    service = new MarketaiService(mockRepository);
  });
