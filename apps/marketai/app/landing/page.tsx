    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-green-900 to-slate-900 text-white">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            >
              AI-driven marketing automation platform with campaign optimization and audience targeting.
            </motion.p>
      ...
      <section id="features" className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Experience the future of Marketing with our comprehensive platform
          </p>
        </motion.div>
          ...
          {[
            {
              ...
              description: 'AI-driven campaign optimization with performance prediction and tuning'
            },
            {
              icon: <Users className="w-8 h-8" />,
              title: 'Audience Targeting',
              description: 'Advanced audience segmentation and personalized targeting strategies'
            },
            {
              icon: <Zap className="w-8 h-8" />,
              title: 'Content Strategy',
              description: 'Intelligent content planning and optimization for maximum engagement'
            }
          ].map((feature, index) => (
            <motion.div
              key={index}
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Join thousands of users who are already using MARKETAI to achieve better results faster.
          </p>
          <button
            onClick={handleGetStarted}
      ...
      <footer className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-800">
        <div className="text-center text-gray-400">
          <p>&copy; 2025 MARKETAI. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
