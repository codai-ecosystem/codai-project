...
import { MemoraiRepository } from '../src/repositories/MemoraiRepository';

describe('MemoraiService', () => {
  let service: MemoraiService;
  let mockRepository: jest.Mocked<MemoraiRepository>;
  ...
  beforeEach(() => {
    ...
    service = new MemoraiService(mockRepository);
  });
