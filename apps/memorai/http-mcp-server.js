...
class MemorAIMCPHTTPServer {
    ...
    async handleRemember(args) {
        ...
        // Store in memory (in production, this would go to CBD)
        ...
        try {
            ...
            if (response.ok) {
                console.log('Memory stored in CBD successfully');
            }
        } catch (error) {
            console.log('CBD not available, using local storage');
        }
    ...
    async handleRecall(args) {
        ...
        try {
            ...
            console.log('CBD search not available, using local search');
        }
