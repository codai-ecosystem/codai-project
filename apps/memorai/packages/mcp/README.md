# 🚀 MemorAI MCP - Ultra-Fast Memory Server

**Enterprise-grade Model Context Protocol (MCP) server delivering sub-100ms response times with comprehensive performance debugging.**

## ⚡ Performance Features

- **Sub-1ms Response Times** - Optimized for maximum speed
- **Comprehensive Debug Info** - Every response includes detailed timing and operation tracking
- **Production-Safe Logging** - Minimal overhead performance monitoring
- **Enterprise-Grade Error Handling** - Detailed stack traces and troubleshooting guides
- **Advanced Caching** - Intelligent cache management with hit/miss reporting
- **Memory Efficiency Monitoring** - Real-time performance metrics
...
```bash
npm install -g @codai/memorai-mcp@latest
```
...
### Ultra-Fast Mode (Sub-100ms)

For maximum performance, use the ultra-fast server:

```json
{
  "servers": {
    "MemoraiUltraFastServer": {
      "type": "stdio", 
      "command": "memorai-mcp-ultra",
      "env": {
        "NODE_ENV": "production"
      }
    }
...
### Response Example with Debug Info
...
```json
{
  ...
  "debug": {
    "requestId": "ultra-1752138525211-6zvxv4",
    "totalResponseTime": "1ms",
    "memoriesProcessed": 3,
    "searchQuery": "performance test",
    "cacheStatus": "hit",
    "timestamp": "2025-07-10T09:08:45.212Z"
  },
  "performance": {
    "responseTime": "1ms",
