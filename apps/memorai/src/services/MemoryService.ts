...
import { MemoryEntity, MemoryStats, QueryRequest, QueryResponse, MemoryRequest, MemoryResponse, DatabaseConfig } from '../types'
...
export class MemoryService {
    ...
    private initializeMockData(): void {
        const mockMemories: MemoryEntity[] = [
            ...
            },
            {
                ...
                content: 'Updated all 11 Codai services to latest library versions while maintaining Tailwind CSS v3. Achieved Next.js 15.3.4, React 18.3.1, TypeScript 5.5.0+.',
            ...
            },
            {
                ...
                content: 'Implementing Model Context Protocol server for AI agent memory management. Supports multi-database backends, real-time sync, and enterprise security.',
            ...
            },
            {
                ...
                content: 'Successfully integrated 11/11 Codai services into monorepo. All services have Next.js foundation, agent configs, and VS Code tasks. Ready for parallel development.',
            ...
            },
            {
                ...
                content: 'Phase 2 focus on foundation services: memorai (memory management), logai (authentication), x (API gateway). Each service needs comprehensive business logic.',
    ...
    private updateStats(): void {
        ...
        this.stats = {
            ...
            avgRelevance: memoriesArray.reduce((sum, m) => sum + m.relevance, 0) / memoriesArray.length,
            memoryUsage: Math.min(85, Math.floor(Math.random() * 40) + 60), // Mock memory usage
            activeAgents: new Set(memoriesArray.map(m => m.agentId).filter(Boolean)).size,
    ...
    public async updateMemory(id: string, updates: Partial<MemoryEntity>): Promise<{ success: boolean; message: string }> {
