            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-xl border border-blue-100 p-6">
              ...
              <div className="space-y-4 max-h-[600px] overflow-y-auto">
                {filteredConversations.map((conversation) => (
                  <div
                    key={conversation.id}
                    className={`p-4 rounded-lg border transition-all duration-300 cursor-pointer ${selectedConversation === conversation.id
                ...
                <div className="border-t border-blue-100 pt-6">
                  ...
                  <div className="space-y-3 max-h-80 overflow-y-auto">
                    {sampleMessages.map((message) => (
                      ...
                      >
                        <div className={`max-w-xs px-3 py-2 rounded-lg text-sm ${message.speaker === 'user'
