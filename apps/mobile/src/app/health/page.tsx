...
export default function HealthPage() {
    const healthData = {
        ...
        uptime: '3h 42m',
        checks: [
            { name: 'iOS Build Service', status: 'healthy', responseTime: '8ms' },
            { name: 'Android Build Service', status: 'healthy', responseTime: '12ms' },
            { name: 'Web App Service', status: 'healthy', responseTime: '6ms' },
            { name: 'Push Notification Service', status: 'healthy', responseTime: '25ms' }
        ]
    }
        ...
        <div className="min-h-screen bg-gray-50 p-6">
            <div className="mx-auto max-w-4xl space-y-6">
                <div className="flex items-center space-x-3">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900">Mobile Health Status</h1>
                        <p className="text-gray-600">Cross-platform mobile services monitoring</p>
                    </div>
                </div>
                ...
                <div className="p-6 border-0 shadow-sm bg-white rounded-lg">
                    <h3 className="text-lg font-semibold text-gray-900 mb-4">Platform Health Checks</h3>
