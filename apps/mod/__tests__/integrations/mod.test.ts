...
import { ModIntegrationManager } from '@/lib/integrations/mod';

describe('mod Integration Tests', () => {
  let integrationManager: ModIntegrationManager;

  beforeEach(() => {
    integrationManager = new ModIntegrationManager();
  });
