...
import { ModRepository } from '../src/repositories/ModRepository';

describe('ModRepository Database Tests', () => {
  let prisma: PrismaClient;
  let repository: ModRepository;
  ...
  beforeAll(async () => {
    ...
    repository = new ModRepository(prisma);
