...
import { PublicaiIntegrationManager } from '@/lib/integrations/publicai';

describe('publicai Integration Tests', () => {
  let integrationManager: PublicaiIntegrationManager;

  beforeEach(() => {
    integrationManager = new PublicaiIntegrationManager();
  });
