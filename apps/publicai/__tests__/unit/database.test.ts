...
import { PublicaiRepository } from '../src/repositories/PublicaiRepository';

describe('PublicaiRepository Database Tests', () => {
  let prisma: PrismaClient;
  let repository: PublicaiRepository;
  ...
  beforeAll(async () => {
    ...
    repository = new PublicaiRepository(prisma);
