  ...
  const [featureCards] = useState<FeatureCard[]>([
    {
      id: '1',
      title: 'AI Tools',
      description: 'Advanced ai tools capabilities with AI optimization',
      icon: 'Globe',
      status: 'active'
    },
    {
      id: '2',
      title: 'Public APIs',
      description: 'Advanced public apis capabilities with AI optimization',
      icon: 'Zap',
      status: 'active'
    },
    {
          ...
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Public AI Services</p>
              </div>
            </motion.div>
        ...
        <AnimatePresence mode="wait">
          {activeTab === 'overview' && (
            ...
            >
              ...
              >
                <h2 className="text-2xl font-bold text-green-400 mb-4">Public-facing AI services and tools for general use</h2>
