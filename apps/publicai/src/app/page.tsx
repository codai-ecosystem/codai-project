...
export default function PublicaiPage() {
  ...
  return (
    <div className={inter.className}>
      <main className="min-h-screen bg-gradient-to-br from-slate-900 via-teal-900 to-slate-900 text-white">
        {/* Animated Background */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -inset-[10px] opacity-50">
            <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-teal-500 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"></div>
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-slate-300">
                  Port 4040 • {isOnline ? 'Online' : 'Offline'}
                </span>
              </div>
        ...
        <div className="relative z-10 container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-300 max-w-2xl mx-auto mb-8">
              Civic AI & Transparency Tools
            </p>
            <div className="flex items-center justify-center space-x-2 text-teal-400">
              <div className="w-3 h-3 bg-teal-400 rounded-full animate-pulse"></div>
              <span className="text-sm font-medium">Running on port 4040</span>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="glass-card p-6 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
              <div className="w-12 h-12 bg-gradient-to-r from-teal-500 to-purple-600 rounded-lg flex items-center justify-center mb-4">
          ...
          <div className="mt-16 text-center">
            <div className="inline-flex items-center px-6 py-3 glass-card">
              <div className="w-2 h-2 bg-teal-400 rounded-full animate-pulse mr-3"></div>
              <span className="text-teal-400 font-medium">System Operational • Live Data Streaming</span>
            </div>
          </div>
