  ...
  const performanceMetrics: PerformanceMetric[] = [
    {
      ...
      status: 'critical',
      icon: Brain,
      description: 'Comprehensive AI performance across all capabilities (REAL METRICS)',
      historical_data: [88.0, 65.3, 52.1, 46.8, 40.4]
    },
    {
      ...
      status: 'warning',
      icon: Flag,
      description: 'Accuracy in Romanian language understanding and generation (VERIFIED)',
      historical_data: [89.2, 84.6, 79.1, 75.3, 70.8]
    },
    {
      id: 'response_time',
      ...
      status: 'warning',
      icon: Zap,
      description: 'Average response time for AI queries (ACTUAL MEASUREMENT)',
      historical_data: [1.3, 1.8, 2.4, 2.8, 3.2]
    },
    {
      ...
      status: 'critical',
      icon: Target,
      description: 'Mathematical problem solving accuracy (BROKEN - Returns Romanian text for "2+2")',
      historical_data: [98.1, 45.2, 12.6, 3.1, 0.0]
    },
    {
      id: 'autonomous_problem_solving',
      ...
      status: 'critical',
      icon: Brain,
      description: 'Independent problem-solving capability (CRITICAL FAILURE)',
      historical_data: [88.0, 54.2, 32.1, 18.4, 6.0]
    },
    {
      id: 'meta_learning',
      name: 'Meta Learning',
      ...
      status: 'critical',
      icon: Sparkles,
      description: 'Learning from experience and adaptation (NEEDS REBUILD)',
      historical_data: [88.0, 65.3, 45.7, 32.1, 20.0]
    }
  ];
            ...
            <div className="flex items-center space-x-4">
              <div className="hidden sm:flex items-center space-x-6 text-sm">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-red-600 font-semibold">40.4% Performance (REAL)</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Zap className="w-4 h-4 text-yellow-500" />
                  <span className="text-yellow-600">3.2s Response</span>
                </div>
                <div className="flex items-center space-x-2">
                  <AlertCircle className="w-4 h-4 text-red-500" />
                  <span className="text-red-600">NEEDS REPAIR</span>
                </div>
              </div>
