            ...
            for i, enrich_proposal in enumerate(enrichment_proposals):
                proposal = ImprovementProposal(
                    ...
                    expected_metrics=ImprovementMetrics(
                        ...
                        semantic_consistency_score=await self._get_real_quality_score(context, evaluation_data),
                        cultural_preservation_score=await self._get_real_quality_score(context, evaluation_data),
                        elder_approval_score=await self._get_real_quality_score(context, evaluation_data)
                    ),
                    cultural_impact=CulturalImpact(
                        preservation_level=CulturalPreservationLevel.ENHANCED,
                        cultural_authenticity_score=await self._get_real_quality_score(context, evaluation_data),
