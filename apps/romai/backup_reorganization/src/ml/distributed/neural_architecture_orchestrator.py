...
async def create_neural_cluster_orchestrator(orchestrator_id: str = "production_orchestrator"):
    """Create and initialize a neural cluster orchestrator for production use"""
    orchestrator = NeuralClusterOrchestrator(orchestrator_id=orchestrator_id)
    logger.info(f"✅ Neural Cluster Orchestrator created: {orchestrator_id}")
    return orchestrator