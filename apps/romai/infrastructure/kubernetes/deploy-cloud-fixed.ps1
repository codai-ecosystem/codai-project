...
Write-Host "Deploying GKE cluster with Terraform..." -ForegroundColor Yellow
...
# Deploy monitoring
kubectl apply -f romai-monitoring.yaml
...
function Deploy-AKS {
    ...
    Write-Host "Creating storage account for Terraform state..." -ForegroundColor Yellow
    ...
    # Initialize and deploy Terraform
    Write-Host "Deploying AKS cluster with Terraform..." -ForegroundColor Yellow
...
function Deploy-EKS {
    ...
    # Initialize and deploy Terraform
    Write-Host "Deploying EKS cluster with Terraform..." -ForegroundColor Yellow
...
function Show-DeploymentMenu {
    Write-Host "`nROMAI Multi-Cloud Deployment Menu" -ForegroundColor Cyan
...
function Validate-Deployment {
    Write-Host "`nRunning post-deployment validation..." -ForegroundColor Cyan
...
Write-Host "`nROMAI Cloud Deployment completed successfully!" -ForegroundColor Green
