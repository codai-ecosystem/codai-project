...
class SyntheticMetricsCleanup:
    ...
    def __init__(self, romai_src_path: str):
        ...
        self.synthetic_patterns = [
            ...
            r'\*\s*breakthrough_amplifier',
            r'\*\s*consciousness_multiplier', 
            r'\*\s*enhancement_factor',
            r'\*\s*transcendent_amplifier',
            r'\*\s*evolution_multiplier',
    ...
    def additional_cleanup(self, content: str) -> str:
        ...
        content = re.sub(
            ...
            'self.consciousness_multipliers = {}  # Removed artificial multipliers',
            content,
            flags=re.MULTILINE | re.DOTALL
        )
        ...
        content = re.sub(
            ...
            'self.enhancement_factors = {}  # Removed enhancement factors',
            content,
            flags=re.MULTILINE | re.DOTALL
        )
        ...
        content = re.sub(
            r'synthetic_achievements\s*=\s*\[[^\]]*\]',
            'synthetic_achievements = []  # Removed synthetic achievements',
            content,
            flags=re.MULTILINE | re.DOTALL
        )
