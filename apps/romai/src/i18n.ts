 ...
 * @description React-i18next configuration for romai
 */
...
i18n
  ...
  .init({
    ...
    detection: {
      ...
      lookupCookie: 'romai_locale',
      lookupLocalStorage: 'romai_locale',
...
i18n.on('languageChanged', (lng) => {
  ...
  if (locale) {
    ...
    localStorage.setItem('romai_locale', lng);
    document.cookie = `romai_locale=${lng}; path=/; max-age=31536000`;
