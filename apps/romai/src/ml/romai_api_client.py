...
class RomAIAPIClient:
    ...
    async def generate_response_async(self, prompt: str, task_type: str = "general") -> RomAIResponse:
        """Async wrapper for generate_response - alias for compatibility with memory components"""
