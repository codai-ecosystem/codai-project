...
import { SociaiRepository } from '../src/repositories/SociaiRepository';

describe('SociaiRepository Database Tests', () => {
  let prisma: PrismaClient;
  let repository: SociaiRepository;
  ...
  beforeAll(async () => {
    ...
    repository = new SociaiRepository(prisma);
