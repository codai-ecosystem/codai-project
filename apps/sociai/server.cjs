...
const server = http.createServer((req, res) => {
  ...
  if (pathname === '/health') {
    ...
    res.end(JSON.stringify({ 
      ...
      description: 'AI Social Platform - Community networking with AI-powered features',
  ...
  if (pathname === '/api/info') {
    ...
    res.end(JSON.stringify({
      ...
      description: 'AI Social Platform - Community networking with AI-powered features',
      port: PORT,
      features: ["Social Networking","Community Features","AI-powered Matching","Content Moderation"],
      status: 'operational',
      uptime: process.uptime()
    }));
    return;
      ...
      <body>
        <div class="container">
          <div class="header">
            ...
            <p>AI Social Platform - Community networking with AI-powered features</p>
            <div>
              <span class="badge">App Category</span>
              <span class="badge">Port: 3007</span>
