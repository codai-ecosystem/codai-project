    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-green-900 to-slate-900 text-white">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            >
              AI-powered stock market analysis and trading platform with predictive modeling.
            </motion.p>
          ...
          {[
            {
              ...
              description: 'Advanced market prediction using machine learning and data analysis'
            },
            {
              icon: <Users className="w-8 h-8" />,
              title: 'Trading Algorithms',
              description: 'Sophisticated trading algorithms with risk management and optimization'
            },
            {
              icon: <Zap className="w-8 h-8" />,
              title: 'Portfolio Analytics',
              description: 'Comprehensive portfolio analysis with performance tracking and insights'
            }
          ].map((feature, index) => (
            <motion.div
              key={index}
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Join thousands of users who are already using STOCAI to achieve better results faster.
          </p>
          <button
            onClick={handleGetStarted}
      ...
      <footer className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-800">
        <div className="text-center text-gray-400">
          <p>&copy; 2025 STOCAI. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
