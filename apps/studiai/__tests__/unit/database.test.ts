...
import { StudiaiRepository } from '../src/repositories/StudiaiRepository';

describe('StudiaiRepository Database Tests', () => {
  let prisma: PrismaClient;
  let repository: StudiaiRepository;
  ...
  beforeAll(async () => {
    ...
    repository = new StudiaiRepository(prisma);
