    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-violet-900 to-slate-900 text-white">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            >
              AI-powered learning platform with personalized education and progress tracking.
            </motion.p>
          ...
          {[
            {
              ...
              description: 'AI-adapted learning paths tailored to individual student needs'
            },
            {
              icon: <Users className="w-8 h-8" />,
              title: 'Progress Tracking',
              description: 'Comprehensive progress monitoring with detailed analytics and insights'
            },
            {
              icon: <Zap className="w-8 h-8" />,
              title: 'Interactive Content',
              description: 'Engaging interactive learning materials with multimedia integration'
            }
          ].map((feature, index) => (
            <motion.div
              key={index}
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          <h2 className="text-4xl font-bold text-white mb-6">
            Ready to Transform Your Education Workflow?
          </h2>
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Join thousands of users who are already using STUDIAI to achieve better results faster.
          </p>
          <button
            onClick={handleGetStarted}
      ...
      <footer className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-800">
        <div className="text-center text-gray-400">
          <p>&copy; 2025 STUDIAI. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
