      ...
      try {
        ...
        for (const courseId in courses) {
          ...
          const inProgressCount = Math.floor(
            Math.random() * (totalStudents - completeCount)
          );
          const notStartedCount =
            totalStudents - completeCount - inProgressCount;
          ...
          <CardBody className="text-center p-6">
            <div className="text-4xl font-bold text-purple-600 dark:text-purple-400 mb-2">
              {formatTime(
                Math.round(
                  engagementData.reduce(
                    (sum, course) => sum + course.averageTime,
                    0
                  ) / engagementData.length
                )
              )}
                    ...
                    <TableCell>
                      <div className="w-full h-6 flex rounded-full overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${((course.progressData?.completeCount || 0) / course.totalStudents) * 100}%`,
                          }}
                        ...
                        <div
                          ...
                          style={{
                            width: `${((course.progressData?.inProgressCount || 0) / course.totalStudents) * 100}%`,
                          }}
                        ...
                        <div
                          ...
                          style={{
                            width: `${((course.progressData?.notStartedCount || 0) / course.totalStudents) * 100}%`,
                          }}
