...
export default function AddCourse(props: AddCourseProps) {
  ...
  const handleAddRequirement = () => {
    if (
      currentRequirement &&
      !courseRequirements.includes(currentRequirement)
    ) {
          ...
          <CardBody className="p-6 overflow-visible">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div>
                ...
                <div className="grid grid-cols-2 gap-6 mb-6">
                  ...
                  <Input
                    ...
                    startContent={
                      <FiClock className="text-[color:var(--ai-muted)]" />
                    }
                ...
                <Input
                  ...
                  startContent={
                    <FiCode className="text-[color:var(--ai-muted)]" />
                  }
              ...
              <div>
                <div className="mb-6">
                  <label className="text-sm font-medium text-[color:var(--ai-foreground)] mb-2 flex items-center gap-2">
                    <FiImage className="text-[color:var(--ai-primary)]" />{' '}
                    Course Image
                  </label>
                  <CourseImageField
                ...
                <div className="mb-6">
                  <Select
                    ...
                    startContent={
                      <FiTarget className="text-[color:var(--ai-muted)]" />
                    }
                    classNames={{
                      label: 'text-[color:var(--ai-foreground)] font-medium',
                      listboxWrapper: 'z-[9999]',
                      trigger:
                        'focus:ring-2 focus:ring-[color:var(--ai-primary)]/20',
                    }}
                  >
                    <SelectItem
                      itemKey="beginner"
                ...
                <div className="mb-6">
                  <label className="flex items-center gap-2 text-sm font-medium text-[color:var(--ai-foreground)] mb-3">
                    <FiFileText className="text-[color:var(--ai-primary)]" />{' '}
                    Category
                  </label>
                  <div className="flex flex-wrap gap-2 mb-3 min-h-[40px] p-2 rounded-lg border border-[color:var(--ai-card-border)]/50">
                    {courseCategory ? (
                      ...
                      <p className="text-sm text-[color:var(--ai-muted)] italic">
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      startContent={
                        <FiFileText
                          className="text-[color:var(--ai-muted)]"
                          size={16}
                        />
                      }
                      list="categories"
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  <label className="text-sm font-medium text-[color:var(--ai-foreground)] mb-2 block">
                    Certificate
                  </label>
                  <Tooltip
          ...
          <CardBody className="p-6">
            <div className="bg-gradient-to-r from-[color:var(--ai-primary)]/5 to-[color:var(--ai-secondary)]/5 rounded-xl p-4 mb-6">
              <p className="text-sm text-[color:var(--ai-muted)]">
                ...
                Choose a competitive price that reflects the value of your
            ...
            <Select
              ...
              startContent={
                <FiDollarSign className="text-[color:var(--ai-muted)]" />
              }
              classNames={{
                label: 'text-[color:var(--ai-foreground)] font-medium',
                listboxWrapper: 'z-[9999]',
            ...
            <div className="flex items-center mt-4">
              ...
              <Tooltip
                ...
                placement="right"
              >
                <div className="ml-1 text-[color:var(--ai-muted)] cursor-help">
                  ⓘ
                </div>
              </Tooltip>
            </div>
        ...
        <Card className="shadow-xl border border-[color:var(--ai-card-border)] overflow-hidden mb-8 hover:shadow-[color:var(--ai-primary)]/5 transition-all">
          <CardHeader className="flex gap-3 px-6 py-4 border-b border-[color:var(--ai-card-border)]/60 bg-gradient-to-r from-[color:var(--ai-primary)]/5 via-[color:var(--ai-secondary)]/5 to-transparent">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-[color:var(--ai-muted)] text-sm">
                Enhance your course with additional information
              </p>
            </div>
          </CardHeader>
          <CardBody className="p-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div>
                ...
                <div className="mb-6">
                  <label className="flex items-center gap-2 text-sm font-medium text-[color:var(--ai-foreground)] mb-3">
                    <FiTarget className="text-[color:var(--ai-primary]" /> What
                    You'll Learn
                  </label>
                  <div className="space-y-2 mb-3 min-h-[100px]">
                    {courseObjectives.length > 0 ? (
                      courseObjectives.map((objective, index) => (
                        <div
                          key={index}
                          className="flex justify-between items-center p-3 rounded-lg bg-[color:var(--ai-card-bg)]/50 border border-[color:var,--ai-card-border)]/50 hover:border-[color:var(--ai-primary)]/20 hover:bg-[color:var(--ai-card-bg)] transition-all"
                        >
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      onKeyPress={(e: KeyboardEvent) =>
                        e.key === 'Enter' && handleAddObjective()
                      }
                      className="bg-[color:var(--ai-card-bg)]/40"
                      startContent={
                        <FiTarget
              ...
              <div>
                <div>
                  <label className="flex items-center gap-2 text-sm font-medium text-[color:var(--ai-foreground)] mb-3">
                    <FiList className="text-[color:var(--ai-primary)]" /> Course
                    Requirements
                  </label>
                  <div className="space-y-2 mb-3 min-h-[100px]">
                    {courseRequirements.length > 0 ? (
                      ...
                      <div className="flex items-center justify-center h-[100px] border border-dashed border-[color:var(--ai-card-border)] rounded-lg">
                        <p className="text-sm text-[color:var(--ai-muted)] italic">
                          Add prerequisites or requirements for your course
                        </p>
                      </div>
                    )}
                  </div>
                ...
                <div>
                  <label className="flex items-center gap-2 text-sm font-medium text-[color:var(--ai-foreground)] mb-3">
                    <FiLink className="text-[color:var(--ai-primary)]" /> Course
                    Prerequisites
                  </label>
                  <div className="space-y-2 mb-3 min-h-[100px]">
                    {coursePrerequisites.length > 0 ? (
                      coursePrerequisites.map(prerequisiteId => {
                      ...
                      <div className="flex items-center justify-center h-[100px] border border-dashed border-[color:var(--ai-card-border)] rounded-lg">
                        <p className="text-sm text-[color:var(--ai-muted)] italic">
                          Add prerequisite courses that students should complete
                          first
                        </p>
                      </div>
                    )}
                    ...
                    <Button
                      ...
                      onPress={() => {
                        if (
                          ...
                          !coursePrerequisites.includes(selectedPrerequisiteId)
                        ) {
                          setCoursePrerequisites([
                            ...coursePrerequisites,
                            selectedPrerequisiteId,
        ...
        <Card className="shadow-xl border border-[color:var(--ai-card-border)] overflow-hidden mb-8 hover:shadow-[color:var(--ai-primary)]/5 transition-all">
          <CardHeader className="flex gap-3 px-6 py-4 border-b border-[color:var(--ai-card-border)]/60 bg-gradient-to-r from-[color:var(--ai-primary)]/5 via-[color:var(--ai-secondary)]/5 to-transparent">
            <div className="flex items-center justify-center w-6 h-6 rounded-full bg-[color:var(--ai-primary)]/20">
              <span className="text-[color:var(--ai-primary)] font-bold text-sm">
                ✓
              </span>
            </div>
            <div className="flex flex-col">
          ...
          <CardBody className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div className="bg-[color:var(--ai-card-bg)]/50 p-4 rounded-xl border border-[color:var(--ai-card-border)]/50">
                <h3 className="text-sm font-medium text-[color:var(--ai-muted)] mb-1">
                  Course Name
                </h3>
