    ...
    <div className="flex flex-col w-full max-w-7xl mx-auto px-4 py-6 animate-in fade-in duration-500">
      <div className="bg-gradient-to-r from-[color:var(--ai-primary)]/10 via-[color:var(--ai-secondary)]/10 to-[color:var(--ai-accent)]/10 backdrop-blur-sm rounded-2xl p-6 mb-8 border border-[color:var(--ai-card-border)]/50 shadow-xl">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
          ...
          <div className="flex flex-col items-end gap-2">
            ...
            {course && (
              <OfflineButton lesson={lesson} course={course} className="mb-2" />
            )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 px-1">
        ...
        <div className="lg:col-span-2 space-y-8">
            ...
            lesson={
              isUsingOfflineContent
                ? {
                    ...
                    thumbnailUrl:
                      offlineLessonContent?.thumbnailUrl ||
                      lesson.thumbnailUrl ||
                      lesson.thumbnail,
                  }
                : lesson
          ...
          {/* Lesson Content */}
          {(lesson.content ||
            (isUsingOfflineContent && offlineLessonContent?.content)) && (
              ...
              <div className="p-6">
                ...
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html: isUsingOfflineContent
                      ? offlineLessonContent.content
                      : lesson.content,
                  }}
                />
              </div>
            ...
            >
              <LessonNavigation
                ...
                onNavigateLesson={lessonId =>
                  onNavigateLesson && onNavigateLesson(lessonId)
                }
                onClose={onClose}
