  ...
  return (
    <div className="space-y-4">
      {displayAnswers.map(answer => (
        <div
          key={answer.id}
          className="border-t border-[color:var(--ai-card-border)]/20 pt-4"
        >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h4 className="font-medium text-[color:var(--ai-text)]">
                    {answer.userName}
                  </h4>
                  {answer.userRole && (
                    <span
          ...
          <div className="mt-2">
            {answer.htmlContent ? (
              ...
              <p className="text-[color:var(--ai-text-secondary)] whitespace-pre-wrap">
                {answer.content}
              </p>
            )}
          </div>
          ...
          <div className="mt-3">
            ...
            <Button
              size="sm"
              variant={
                user && answer.likedBy?.includes(user.uid) ? 'solid' : 'flat'
              }
              color={
                user && answer.likedBy?.includes(user.uid)
                  ? 'primary'
                  : 'default'
              }
