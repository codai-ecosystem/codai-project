    ...
    return (
      <Card className="border border-[color:var(--ai-card-border)] bg-white dark:bg-[color:var(--ai-card-bg)] rounded-xl shadow-md overflow-hidden mb-8">
        ...
        <CardBody className="p-6">
          ...
          {currentCourse ? (
            <div className="mb-4">
              <div className="text-sm text-[color:var(--ai-muted)] mb-1">
                Current Course
              </div>
              <div className="font-medium text-[color:var(--ai-foreground)] mb-2">
                {currentCourse}
              </div>{' '}
              <Progress
                ...
                classNames={{
                  ...
                  indicator:
                    'bg-gradient-to-r from-[color:var(--ai-primary)] to-[color:var(--ai-secondary)] rounded-full',
                }}
              />
              <div className="text-xs text-[color:var(--ai-muted)] mt-1">
                {currentProgress}% completed
              </div>
            </div>
          ) : (
            <div className="mb-4">
              <div className="text-sm text-[color:var(--ai-muted)] mb-2">
          ...
          {nextCourse && (
            <div>
              ...
              <div className="font-medium text-[color:var(--ai-primary)]">
                {nextCourse}
              </div>
            </div>
          )}
              ...
              >
                    ...
                    className={`rounded-full w-8 h-8 flex items-center justify-center border-2 
                                        ${
                                          node.status === 'completed'
                                            ? 'border-[color:var(--ai-success)] bg-[color:var(--ai-success)]/10'
                                            : node.status === 'in-progress'
                                              ? 'border-[color:var(--ai-primary)] bg-[color:var(--ai-primary)]/10'
                                              : node.status === 'locked'
                                                ? 'border-[color:var(--ai-muted)] bg-[color:var(--ai-muted)]/10'
                ...
                <div className="flex-grow p-3 border border-[color:var(--ai-card-border)] rounded-lg hover:shadow-md transition-shadow bg-[color:var(--ai-card-bg)]/70">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <Chip
                      size="sm"
                      color={getChipColor(node.status)}
                      variant="flat"
                    >
                      {node.status === 'in-progress'
                        ? 'In Progress'
                    ...
                    <div className="mt-2 mb-1">
                      ...
                      <Progress
                        ...
                        classNames={{
                          ...
                          indicator:
                            'bg-[color:var(--ai-primary)] rounded-full',
                        }}
                      />
                      <div className="text-xs text-[color:var(--ai-muted)] mt-1">
