            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-slate-300">
                  Port 4036 • {isOnline ? 'Online' : 'Offline'}
                </span>
              </div>
        ...
        <div className="relative z-10 container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <div className="flex items-center justify-center space-x-2 text-indigo-400">
              ...
              <span className="text-sm font-medium">Running on port 4036</span>
            </div>
          </div>
          ...
          <div className="mt-16 text-center">
            <div className="inline-flex items-center px-6 py-3 glass-card">
              ...
              <span className="text-indigo-400 font-medium">System Operational • Live Data Streaming</span>
            </div>
          </div>
