...
import { ToolsIntegrationManager } from '@/lib/integrations/tools';

describe('tools Integration Tests', () => {
  let integrationManager: ToolsIntegrationManager;

  beforeEach(() => {
    integrationManager = new ToolsIntegrationManager();
  });
