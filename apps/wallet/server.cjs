...
const server = http.createServer((req, res) => {
  ...
  if (pathname === '/health') {
    ...
    res.end(JSON.stringify({ 
      ...
      description: 'Programmable Wallet Platform - Digital asset management and DeFi integration',
  ...
  if (pathname === '/api/info') {
    ...
    res.end(JSON.stringify({
      ...
      description: 'Programmable Wallet Platform - Digital asset management and DeFi integration',
      port: PORT,
      features: ["Digital Asset Management","Multi-chain Support","DeFi Integration","Portfolio Tracking"],
      status: 'operational',
      uptime: process.uptime()
    }));
    return;
      ...
      <body>
        <div class="container">
          <div class="header">
            ...
            <p>Programmable Wallet Platform - Digital asset management and DeFi integration</p>
            <div>
              <span class="badge">App Category</span>
              <span class="badge">Port: 3004</span>
