...
import { XIntegrationManager } from '@/lib/integrations/x';

describe('x Integration Tests', () => {
  let integrationManager: XIntegrationManager;

  beforeEach(() => {
    integrationManager = new XIntegrationManager();
  });
