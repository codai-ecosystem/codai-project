...
import { TemplatesIntegrationManager } from '@/lib/integrations/templates';

describe('templates Integration Tests', () => {
  let integrationManager: TemplatesIntegrationManager;

  beforeEach(() => {
    integrationManager = new TemplatesIntegrationManager();
  });
