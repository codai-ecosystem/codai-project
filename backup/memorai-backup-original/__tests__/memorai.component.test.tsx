...
describe('MemoraiPage Component', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe('Real-time Features', () => {
    it('displays live statistics', () => {
      ...
      expect(screen.getAllByText(/performance/i)[0]).toBeInTheDocument()
    })
  ...
  describe('Platform Features', () => {
    ...
    it('displays performance metrics', () => {
      render(<MemoraiPage />)
      expect(screen.getAllByText(/performance|Active|Live/i)[0]).toBeInTheDocument()
    })

    it('shows platform scale indicator', () => {
      render(<MemoraiPage />)
      expect(screen.getAllByText(/platform|management|AI/i)[0]).toBeInTheDocument()
    })
  })
  ...
  describe('Error Handling', () => {
    it('handles missing props gracefully', () => {
      ...
      expect(() => render(<MemoraiPage />)).not.toThrow()
    })
