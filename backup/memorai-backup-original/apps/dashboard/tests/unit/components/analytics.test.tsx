...
const mockFetchMemories = vi.fn().mockResolvedValue(undefined);
...
describe('AnalyticsDashboard', () => {
  beforeEach(() => {
    mockFetchStats.mockClear().mockResolvedValue(undefined);
    mockFetchMemories.mockClear().mockResolvedValue(undefined);
