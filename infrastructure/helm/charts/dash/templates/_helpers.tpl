...
*/}}
{{- define "dash.configMapName" -}}
{{- printf "%s-config" (include "dash.fullname" .) }}
{{- end }}

{{/*
Create the name of the secret
*/}}
{{- define "dash.secretName" -}}
{{- printf "%s-secret" (include "dash.fullname" .) }}
{{- end }}

{{/*
Database URL helper
*/}}
{{- define "dash.databaseUrl" -}}
...
*/}}
{{- define "dash.podSecurityContext" -}}
securityContext:
