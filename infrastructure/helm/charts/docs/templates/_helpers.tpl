...
*/}}
{{- define "docs.configMapName" -}}
{{- printf "%s-config" (include "docs.fullname" .) }}
{{- end }}
...
{{- printf "%s-secret" (include "docs.fullname" .) }}
{{- end }}

{{/*
Database URL helper
*/}}
{{- define "docs.databaseUrl" -}}
...
*/}}
{{- define "docs.podSecurityContext" -}}
securityContext:
