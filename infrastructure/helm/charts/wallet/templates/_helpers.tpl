...
*/}}
{{- define "wallet.configMapName" -}}
{{- printf "%s-config" (include "wallet.fullname" .) }}
{{- end }}

{{/*
Create the name of the secret
*/}}
{{- define "wallet.secretName" -}}
{{- printf "%s-secret" (include "wallet.fullname" .) }}
{{- end }}

{{/*
Database URL helper
*/}}
{{- define "wallet.databaseUrl" -}}
...
*/}}
{{- define "wallet.podSecurityContext" -}}
securityContext:
