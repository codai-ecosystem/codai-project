...
*/}}
{{- define "x.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "x.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "x.configMapName" -}}
{{- printf "%s-config" (include "x.fullname" .) }}
{{- end }}
...
*/}}
{{- define "x.secretName" -}}
{{- printf "%s-secret" (include "x.fullname" .) }}
{{- end }}

{{/*
Database URL helper
*/}}
{{- define "x.databaseUrl" -}}
