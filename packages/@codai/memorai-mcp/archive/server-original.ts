...
/**
 * MemorAI MCP Server - Simplified Working Version
...
console.error(`[DEBUG] Comparison: ${import.meta.url} === file://${process.argv[1]}`);

// Start immediately if this file is being executed directly
// Multiple conditions to ensure it starts
...
if (isMainModule) {
    ...
    console.error('[INIT] Not main module, not starting server automatically');
}
