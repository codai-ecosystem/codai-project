...
impl KubernetesComplianceValidator {
    ...
    pub async fn initialize_production_policies(&self) -> Result<(), ComplianceError> {
        ...
        policies.insert("pod-security-restricted".to_string(), SecurityPolicyRule {
            ...
            kubernetes_manifest: include_str!("../../../../../infrastructure/k8s/security/pod-security-policy.yaml").to_string(),
        ...
        policies.insert("network-isolation".to_string(), SecurityPolicyRule {
            ...
            kubernetes_manifest: include_str!("../../../../../infrastructure/k8s/security/network-policies.yaml").to_string(),
            validation_rules: vec![
                ValidationRule {
        ...
        policies.insert("rbac-least-privilege".to_string(), SecurityPolicyRule {
            ...
            kubernetes_manifest: include_str!("../../../../../infrastructure/k8s/security/security-policies.yaml").to_string(),
            validation_rules: vec![
                ValidationRule {
