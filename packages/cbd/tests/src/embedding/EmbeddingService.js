...
exports.EmbeddingService = exports.LocalEmbeddingModel = exports.OpenAIEmbeddingModel = void 0;
var OpenAIEmbeddingModel = /** @class */ (function () {
    function OpenAIEmbeddingModel(apiKey, modelName) {
...
var LocalEmbeddingModel = /** @class */ (function () {
    function LocalEmbeddingModel(modelName) {
...
exports.LocalEmbeddingModel = LocalEmbeddingModel;
var EmbeddingService = /** @class */ (function () {
    function EmbeddingService(model) {
        this.model = model;
    }
