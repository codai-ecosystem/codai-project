...
export const CBD_DESCRIPTION = export const CBD_VERSION = export const CBDNativeStorageAdapter = export const LocalEmbeddingModel = export const OpenAIEmbeddingModel = export const InMemoryVectorIndex = export const FaissVectorStore = export const CBDMemoryEngine = void 0;
export const createCBDEngine = createCBDEngine;
export const validateCBDConfig = validateCBDConfig;
 ...
 */
function createCBDEngine(config): any {
 ...
 */
export const CBD_VERSION = '1.0.0';
export const CBD_DESCRIPTION = 'Codai Better Database - Revolutionary vector-native AI memory system';
/**
 * Utility function to validate CBD configuration
 */
function validateCBDConfig(config): any {
    var _a, _b, _c, _d, _e;
    var errors = [];
