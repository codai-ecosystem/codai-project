...
export const quickHealthCheck = quickHealthCheck;
/**
 * Perform comprehensive health check of CBD MCP server
 */
function healthCheck(engine, config): any {
 ...
 */
function validateHealthConfig(config): any {
    var errors = [];
 ...
 */
function quickHealthCheck(engine): any {
    return __awaiter(this, void 0, void 0, function () {
        var error_3;
