...
exports.demonstrateEnhancedGlassBrowser = demonstrateEnhancedGlassBrowser;
exports.debugCurrentPage = debugCurrentPage;
const enhanced_vercel_automation_1 = require("./src/enhanced-vercel-automation");
async function demonstrateEnhancedGlassBrowser() {
    console.log('🚀 Starting Enhanced Glass MCP Browser Automation Demo');
    console.log('================================================');
    const vercelAutomation = new enhanced_vercel_automation_1.EnhancedVercelAutomation();
    try {
        ...
        if (navResult.success) {
            ...
            if (navResult.details?.actionableElements) {
                ...
                navResult.details.actionableElements.forEach((el, i) => {
        ...
        if (findResult.success) {
            ...
            if (findResult.details?.suggestions) {
                ...
                findResult.details.suggestions.forEach((suggestion, i) => {
            ...
            if (findResult.details) {
                ...
                if (findResult.details.actionableElements) {
                    ...
                    findResult.details.actionableElements.forEach((el, i) => {
        ...
        if (fillResult.success) {
            ...
            if (fillResult.details) {
                ...
                if (fillResult.details.failedFields) {
                    fillResult.details.failedFields.forEach((field) => {
...
async function debugCurrentPage() {
    ...
    try {
        ...
        analysis.actionableElements.slice(0, 10).forEach((el, i) => {
