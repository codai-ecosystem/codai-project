...
export class DOMInspector {
     ...
     */
    async findBestClickableElement(searchText: string): Promise<DOMElement | null> {
     ...
     */
    private generateInspectionScript(): string {
        return `
    (function() {
      const elements = [];
     ...
     */
    private calculateElementScore(element: DOMElement, searchText: string): number {
        let score = 0;
