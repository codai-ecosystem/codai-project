...
exports.GlassMCPConnector = void 0;
class GlassMCPConnector {
    glassEndpoint = 'http://localhost:8001';
    /**
     ...
     */
    async sendText(windowHandle, text) {
        try {
     ...
     */
    async sendTextByTitle(title, text) {
        try {
     ...
     */
    async extractText(windowHandle) {
        try {
     ...
     */
    async extractTextByTitle(title) {
        try {
     ...
     */
    async sendKey(windowHandle, key) {
        try {
     ...
     */
    async sendKeyByTitle(title, key) {
        try {
     ...
     */
    async clickAt(windowHandle, x, y) {
        try {
     ...
     */
    async executeJavaScript(windowHandle, script) {
        try {
...
exports.GlassMCPConnector = GlassMCPConnector;
