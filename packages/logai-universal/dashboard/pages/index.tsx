...
export default function LogAIDashboard() {
  ...
  // Real-time WebSocket connection to LogAI Server
  useEffect(() => {
    const ws = new WebSocket('ws://localhost:8080/logai');

    ws.onopen = () => {
      console.log('🔗 Connected to LogAI Universal Server');
    };
    ...
    ws.onclose = () => {
      console.log('❌ Disconnected from LogAI Universal Server');
    };
