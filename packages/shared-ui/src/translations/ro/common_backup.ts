...
export const commonTranslations = {
  ...
  explorer: {
    dashboard: {
      title: 'CodaiChain Explorer',
      subtitle: 'Blockchain Explorer for the KODEX Network',
      ...
      totalSupply: 'Total KODEX Supply',
      marketCap: 'Market Cap',
      avgBlockTime: 'Avg Block Time',
      hashRate: 'Hash Rate',
      difficulty: 'Difficulty',
      validators: 'Active Validators',
      searchPlaceholder: 'Search blocks, transactions, addresses...',
      blockNumber: 'Block',
      timestamp: 'Timestamp',
      ...
      kodexPrice: 'KODEX Price',
      priceChange: '24h Change',
      volume24h: '24h Volume',
      aiComputeMetrics: 'AI Compute Metrics',
      proofOfIntelligence: 'Proof of Intelligence',
