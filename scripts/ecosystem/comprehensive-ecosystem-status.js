...
async function runComprehensiveCheck() {
    ...
    fs.writeFileSync(
        path.join(__dirname, '../../docs/reports/ECOSYSTEM_STATUS_DETAILED_REPORT.json'),
        JSON.stringify(reportData, null, 2)
    );

    log(`\n💾 Detailed report saved to: docs/reports/ECOSYSTEM_STATUS_DETAILED_REPORT.json`, 'blue');
