    ...
    try {
        ...
        try {
            ...
            try {
                ...
                console.log('⚠️  Clone from codai-ecosystem failed, repository may not exist yet');
                throw new Error(`Repository https://github.com/codai-ecosystem/${appName}.git not accessible`);
            }
        }
