...
try {
  ...
  execSync(
    `git clone https://github.com/codai-ecosystem/templates.git ${templatesRepoPath}`,
    { stdio: 'inherit' }
  );
  ...
  const templateMetadata = {
    ...
    description:
      'Production-ready web application template with Next.js, TypeScript, and Tailwind CSS',
    version: '1.0.0',
    author: 'Codai Team',
...
`;
  ...
  templatesIndex.templates = templatesIndex.templates.filter(
    t => t.name !== 'web-app'
  );
...
`;
  ...
  execSync('git commit -m "Add web-app template (secure)"', {
    stdio: 'inherit',
  });
  ...
  console.log(
    '🌐 Template available at: https://github.com/codai-ecosystem/templates/tree/main/templates/web-app'
  );
} catch (error) {
