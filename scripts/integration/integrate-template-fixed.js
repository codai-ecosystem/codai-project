...
const TEMPLATE_CONFIG = {
  name: 'web-app',
  description:
    'Modern Next.js web application template with TypeScript, Tailwind CSS, and best practices',
...
async function main() {
  ...
  try {
    ...
    try {
      ...
      console.error(
        `❌ Source template not found: ${TEMPLATE_CONFIG.sourcePath}`
      );
      console.log(
