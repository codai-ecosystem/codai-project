                    ...
                    <div className="flex justify-between items-center py-4">
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">AI Services Platform & Orchestration</p>
                            </div>
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-gray-600">
                                Orchestrate AI services, deploy models, and manage the entire AI infrastructure at scale.
                            </p>
                        </div>
                                ...
                                <CardContent className="space-y-4">
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="flex flex-col items-center p-4 border rounded-lg hover:shadow-md transition-shadow">
                                            ...
                                            <span className="text-sm font-medium text-gray-700">NLP Services</span>
                                            <span className="text-xs text-gray-500 mt-1">Text analysis & generation</span>
                                        </div>

                                        <div className="flex flex-col items-center p-4 border rounded-lg hover:shadow-md transition-shadow">
                                            <Cpu className="w-8 h-8 text-green-600 mb-2" />
                                            <span className="text-sm font-medium text-gray-700">Computer Vision</span>
                                            <span className="text-xs text-gray-500 mt-1">Image & video analysis</span>
                                        </div>

                                        <div className="flex flex-col items-center p-4 border rounded-lg hover:shadow-md transition-shadow">
                                            <Network className="w-8 h-8 text-purple-600 mb-2" />
                                            <span className="text-sm font-medium text-gray-700">Model Deployment</span>
                                            <span className="text-xs text-gray-500 mt-1">Scalable ML operations</span>
                                        </div>

                                        <div className="flex flex-col items-center p-4 border rounded-lg hover:shadow-md transition-shadow">
                                            <Database className="w-8 h-8 text-orange-600 mb-2" />
                                            <span className="text-sm font-medium text-gray-700">Data Processing</span>
                                            <span className="text-xs text-gray-500 mt-1">ETL & preprocessing</span>
                                        </div>
                                    </div>
                ...
                <div className="mt-8">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Real-time status of FabricAI integration with other Codai services
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
