  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        {error && (
          <ErrorAlert description={getErrorMessage(error)} />
        )}

        {formError && (
          <ErrorAlert description={formError} />
        )}
            ...
            <div className="space-y-6">
              ...
              <Form onSubmit={handleCredentialSignIn}>
                <div className="space-y-4">
                  ...
                  {requiresMFA && (
                    <FormField>
                      <FormLabel htmlFor="mfaCode">Authentication Code</FormLabel>
                      <FormControl>
                        <Input
                          id="mfaCode"
                  ...
                  <Button
                    type="submit"
                    className="w-full"
                    disabled={loading || !formData.email || !formData.password || (requiresMFA && formData.mfaCode.length !== 6)}
                  >
