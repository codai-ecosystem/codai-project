...
import { Alert, ErrorAlert, SuccessAlert, InfoAlert, WarningAlert } from '@/components/ui/alert';
...
export default function MFAPage() {
    ...
    const handleGenerateBackupCodes = async () => {
        try {
            ...
            const data = await response.json();
            setMfaStatus(prev => prev ? { ...prev, backupCodes: data.backupCodes } : null);
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between p-4 border rounded-lg">
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                                Generate new backup codes if you've lost access to your current ones.
                                            </p>
                                        </div>
                                        <Button
                                            variant="outline"
