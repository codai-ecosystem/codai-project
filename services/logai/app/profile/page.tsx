...
import { Alert, ErrorAlert, SuccessAlert, InfoAlert } from '@/components/ui/alert';
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center space-x-2">
                                        <div className={`h-2 w-2 rounded-full ${profile?.emailVerified ? 'bg-green-500' : 'bg-yellow-500'}`}></div>
                                        <p className="text-sm">
                            ...
                            <div>
                                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Two-Factor Authentication</p>
                                <div className="flex items-center justify-between mt-2">
                                    <div className="flex items-center space-x-2">
                                        <div className={`h-2 w-2 rounded-full ${profile?.mfaEnabled ? 'bg-green-500' : 'bg-gray-400'}`}></div>
                                        <p className="text-sm">
