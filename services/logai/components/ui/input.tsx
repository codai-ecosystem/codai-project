...
const inputVariants = cva(
  'flex h-10 w-full rounded-md border border-gray-200 bg-white px-3 py-2 text-sm ring-offset-white file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-gray-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 dark:border-gray-800 dark:bg-gray-950 dark:ring-offset-gray-950 dark:placeholder:text-gray-400 dark:focus-visible:ring-blue-300',
  {
    variants: {
      variant: {
        default: '',
        destructive: 'border-red-500 focus-visible:ring-red-500 dark:border-red-900 dark:focus-visible:ring-red-900',
        success: 'border-green-500 focus-visible:ring-green-500 dark:border-green-900 dark:focus-visible:ring-green-900',
      },
    },
    defaultVariants: {
      variant: 'default',
...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({ className, variant, type, label, description, error, success, ...props }, ref) => {
    ...
    return (
      <div className="w-full">
        ...
        <input
          ...
          ref={ref}
          aria-describedby={
            description ? descriptionId : error ? errorId : success ? successId : undefined
          }
          {...props}
        />
        {description && (
        ...
        {success && (
          <p id={successId} className="mt-2 text-sm text-green-600 dark:text-green-400">
            {success}
          </p>
        )}
      </div>
