...
export const auditEvents = {
  ...
  roleChange: (userId: string, oldRole: string, newRole: string, changedBy?: string, ipAddress?: string) =>
    auditLogger.log({
      userId,
      action: "role_change",
      ipAddress,
  ...
  apiAccess: (userId: string, endpoint: string, method: string, ipAddress?: string, userAgent?: string) =>
    auditLogger.log({
      userId,
      action: "api_access",
      resource: endpoint,
  ...
  adminAction: (adminId: string, action: string, targetUserId?: string, details?: Record<string, any>, ipAddress?: string) =>
    auditLogger.log({
      userId: adminId,
      action: "admin_action",
