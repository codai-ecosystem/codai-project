...
export class EmailService {
     ...
     */
    async sendSecurityAlertEmail(to: string, alertType: string, details: any): Promise<void> {
        await this.sendEmail({
            to,
     ...
     */
    async sendLoginNotificationEmail(to: string, location: string, device: string): Promise<void> {
        await this.sendEmail({
            to,
