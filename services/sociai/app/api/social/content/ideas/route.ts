...
const mockContentIdeas = [
    ...
    },
    {
        ...
        description: 'Tell a story about how you creatively solved a challenging problem',
        category: 'creative',
...
export async function GET(request: NextRequest) {
    try {
        ...
        const refreshedIdeas = filteredIdeas.map(idea => ({
            ...idea,
            estimatedEngagement: Math.max(60, Math.min(95, idea.estimatedEngagement + (Math.random() * 10 - 5)))
        }));
