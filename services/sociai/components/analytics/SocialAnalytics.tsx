...
interface EngagementTrends {
    ...
    hashtags: { tag: string; performance: number; trend: 'up' | 'down' | 'stable' }[];
...
export default function SocialAnalytics() {
    ...
    const [activeTab, setActiveTab] = useState<'overview' | 'posts' | 'audience' | 'trends'>('overview');
    ...
    const mockPostAnalytics: PostAnalytics[] = [
        {
            id: '1',
            content: 'Just built an amazing AI-powered feature for our social platform! The engagement analytics are mind-blowing 🤯',
        ...
        {
            id: '2',
            content: 'Here\'s your daily AI-generated insight: Communities with active engagement show 3x higher retention rates.',
        ...
        {
            id: '3',
            content: 'Working on something cool today. Can\'t wait to share it with you all!',
        ...
        <div className="max-w-6xl mx-auto p-6">
            <div className="mb-6">
                <div className="flex justify-between items-center">
                    <div>
                        <h2 className="text-2xl font-bold text-gray-900 mb-2">Social Analytics</h2>
                    ...
                    <div className="flex space-x-2">
                        {[
                            ...
                            <button
                                ...
                                className={`px-3 py-1 rounded-lg text-sm font-medium transition-colors ${timeRange === range.key
            ...
            <div className="border-b border-gray-200 mb-6">
                <nav className="flex space-x-8">
                    {[
                        ...
                        { key: 'posts', label: 'Post Performance', icon: ChatBubbleLeftRightIcon },
                        ...
                        <button
                            ...
                            className={`flex items-center py-2 px-1 border-b-2 font-medium text-sm ${activeTab === tab.key
                ...
                <>
                                ...
                                <div className="bg-white rounded-lg shadow-sm border p-6">
                                    <div className="flex items-center">
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="text-sm text-green-600">+{metrics.weeklyGrowth.followers}% this week</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white rounded-lg shadow-sm border p-6">
                                    <div className="flex items-center">
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="text-sm text-green-600">+{metrics.weeklyGrowth.engagement}% this week</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white rounded-lg shadow-sm border p-6">
                                    <div className="flex items-center">
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="text-sm text-green-600">+{metrics.weeklyGrowth.reach}% this week</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="bg-white rounded-lg shadow-sm border p-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div className="p-4 bg-blue-50 rounded-lg">
                                        <h4 className="font-medium text-blue-900">Best Performing Content</h4>
                                        <p className="text-blue-700 text-sm mt-1">Videos get 180% more engagement than text posts</p>
                                    </div>
                                    <div className="p-4 bg-green-50 rounded-lg">
                                        <h4 className="font-medium text-green-900">Optimal Posting Time</h4>
                                        <p className="text-green-700 text-sm mt-1">1:00 PM on Wednesdays shows highest engagement</p>
                                    </div>
                                    <div className="p-4 bg-purple-50 rounded-lg">
                                        <h4 className="font-medium text-purple-900">Growing Hashtag</h4>
                                        <p className="text-purple-700 text-sm mt-1">#AI trending up 95% this month</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                                            ...
                                            <div className="text-center">
                                                <div className="flex items-center justify-center mb-1">
                                                    ...
                                                    <span className="font-semibold">{post.metrics.views}</span>
                                                </div>
                    ...
                    {activeTab === 'audience' && audienceInsights && (
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-6">
                                    <div className="bg-white rounded-lg shadow-sm border p-6">
                                        <h4 className="font-semibold text-gray-900 mb-4">Peak Activity Times</h4>
                                        <div className="space-y-3">
                                            {audienceInsights.activity.peakHours.map((hour) => (
                                                <div key={hour.hour} className="flex items-center justify-between">
                                                    ...
                                                    <div className="flex items-center space-x-2">
                                                        ...
                                                        <span className="text-sm text-gray-600 w-10">{hour.engagement}%</span>
                                                    </div>
                                                </div>
                                            ))}
                                        </div>
                                    ...
                                    <div className="bg-white rounded-lg shadow-sm border p-6">
                                        <h4 className="font-semibold text-gray-900 mb-4">Top Interests</h4>
                                        <div className="space-y-3">
                                            {audienceInsights.demographics.interests.map((interest) => (
                                                <div key={interest.interest} className="flex items-center justify-between">
                                                    ...
                                                    <div className="flex items-center space-x-2">
                                                        ...
                                                        <span className="text-sm text-gray-600 w-10">{interest.percentage}%</span>
                                                    </div>
                                                </div>
                                            ))}
                                        </div>
                    ...
                    {activeTab === 'trends' && engagementTrends && (
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                <div className="bg-white rounded-lg shadow-sm border p-6">
                                    <h4 className="font-semibold text-gray-900 mb-4">Hashtag Performance</h4>
                                    <div className="space-y-3">
                                        {engagementTrends.hashtags.map((hashtag) => (
                                            <div key={hashtag.tag} className="flex items-center justify-between">
                                                ...
                                                <div className="flex items-center space-x-2">
                                                    <span className="text-sm text-gray-600">{hashtag.performance}%</span>
                                                    <span className="text-lg">{getTrendIcon(hashtag.trend)}</span>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                                ...
                                <div className="bg-white rounded-lg shadow-sm border p-6">
                                    <h4 className="font-semibold text-gray-900 mb-4">Content Type Performance</h4>
                                    <div className="space-y-3">
                                        {engagementTrends.contentTypes.map((type) => (
                                            <div key={type.type} className="flex items-center justify-between">
                                                <div className="flex items-center">
                                                    <span className="text-gray-700">{type.type}</span>
                                                    <span className="text-xs text-gray-500 ml-2">({type.count} posts)</span>
                                                </div>
                                                <div className="flex items-center space-x-2">
                                                    <div className="w-24 bg-gray-200 rounded-full h-2">
                                                        <div
                                                            className="bg-blue-600 h-2 rounded-full"
                                                            style={{ width: `${Math.min(type.avgEngagement, 200) / 2}%` }}
                                                        ></div>
                                                    </div>
                                                    <span className="text-sm text-gray-600 w-10">{type.avgEngagement}</span>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                            ...
                            {/* Daily Trends Chart */}
                            <div className="bg-white rounded-lg shadow-sm border p-6">
                                <h4 className="font-semibold text-gray-900 mb-4">Daily Engagement & Reach</h4>
                                <div className="h-64 flex items-end space-x-2">
                                    {engagementTrends.daily.map((day, index) => (
                                        <div key={day.date} className="flex-1 flex flex-col items-center">
                                            <div className="w-full bg-blue-100 rounded-t-lg relative" style={{ height: `${day.engagement}%` }}>
                                                <div
