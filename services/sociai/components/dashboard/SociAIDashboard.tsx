...
export default function SociAIDashboard() {
    const [activeTab, setActiveTab] = useState<'feed' | 'create' | 'communities' | 'messaging' | 'analytics'>('feed');
                        ...
                        <div className="flex items-center space-x-4">
                            <div className="flex items-center">
                                ...
                                <div className="ml-3">
                                    ...
                                    <p className="text-sm text-gray-500">AI-Native Social Platform</p>
                                </div>
                            </div>
                        </div>
                                ...
                                {quickStats.map((stat, index) => (
                                    <div key={index} className="text-center">
                                        <div className="flex items-center justify-center mb-1">
                                            ...
                                            <span className={`text-xs ml-1 ${stat.trend === 'up' ? 'text-green-600' :
                            ...
                            <nav className="space-y-2">
                                {navigationItems.map((item) => (
                                    <button
                                        ...
                                        className={`w-full flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors ${activeTab === item.key
