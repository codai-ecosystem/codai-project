...
export default function SocialFeedManager() {
    ...
    const [activeFilter, setActiveFilter] = useState<'all' | 'following' | 'trending' | 'ai'>('all');
    ...
    const handleEngagement = async (postId: string, action: 'like' | 'bookmark' | 'share') => {
        try {
                ...
                <div className="lg:col-span-1">
                        ...
                        <div className="space-y-3">
                            {communities.map((community) => (
                                <div key={community.id} className="flex items-center justify-between">
                                    ...
                                    <button
                                        className={`text-xs px-2 py-1 rounded-full ${community.isJoined
                    ...
                    <div className="bg-white rounded-lg shadow-sm border p-4">
                        ...
                        <div className="space-y-2">
                            {['#AIInnovation', '#SocialTech', '#CommunityBuilding', '#TechTrends'].map((tag) => (
                                <div key={tag} className="flex items-center justify-between">
                                    <span className="text-sm text-blue-600 hover:text-blue-800 cursor-pointer">{tag}</span>
                            ...
                            <div className="flex space-x-2">
                                {[
                                    ...
                                    <button
                                        ...
                                        className={`px-3 py-1 rounded-full text-sm font-medium transition-colors ${activeFilter === filter.key
                                                ? 'bg-blue-100 text-blue-700'
                                                ...
                                                {post.content.hashtags.length > 0 && (
                                                    <div className="mt-2 flex flex-wrap gap-2">
                                                        {post.content.hashtags.map((tag) => (
                                                            <span key={tag} className="text-blue-600 hover:text-blue-800 cursor-pointer">
                                                                #{tag}
                                                            </span>
                                                        ))}
                                                    </div>
